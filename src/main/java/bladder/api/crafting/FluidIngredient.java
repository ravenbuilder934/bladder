 ...
 * Example JSON object: { "type": "bladder:fluid", "tag": "minecraft:lava", "amount": 1000, "exact":true }
...
public class FluidIngredient extends Ingredient
{
    ...
    public static final class Serializer implements IIngredientSerializer<FluidIngredient>
    {
        ...
        public static final ResourceLocation NAME = new ResourceLocation(Bladder.MOD_ID, "fluid");
