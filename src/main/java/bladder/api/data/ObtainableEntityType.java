...
public class ObtainableEntityType
{
    ...
    public ObtainableEntityType(@Nonnull ResourceLocation entityType, List<Fluid> fluids, List<ITag<Fluid>> fluidTags, ResourceLocation emptySound, ResourceLocation fillSound)
    {
    ...
    public static class Builder
    {
        ...
        {
            return new ObtainableEntityType(this.entityType, this.fluids, this.fluidTags, this.emptySound, this.fillSound);
        }
