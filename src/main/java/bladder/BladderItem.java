...
public class BladderItem extends Item
{
    ...
    @Deprecated
    public BladderItem(Fluid p_i49025_1_, Item.Properties p_i49025_2_)
    {
        super(p_i49025_2_);
     ...
     */
    public BladderItem(java.util.function.Supplier<? extends Fluid> supplier, Item.Properties builder)
    {
        super(builder);
        this.content = null;
        ...
        else
        {
            ...
            if (p_77659_1_.mayInteract(p_77659_2_, blockpos) && p_77659_2_.mayUseItemAt(blockpos1, direction, itemstack))
            {
                ...
                else
                {
                    ...
                    if (this.emptyBladder(p_77659_2_, p_77659_1_, blockpos2, blockraytraceresult))
                    {
    ...
    {
        return !p_203790_2_.abilities.instabuild ? new ItemStack(ItemRegistry.emptybladder.get()) : p_203790_1_;
    }
    ...
    public boolean emptyBladder(@Nullable PlayerEntity p_180616_1_, World p_180616_2_, BlockPos p_180616_3_, @Nullable BlockRayTraceResult p_180616_4_)
    {
        ...
        else
        {
            ...
            if (!flag1)
            {
                return p_180616_4_ != null && this.emptyBladder(p_180616_1_, p_180616_2_, p_180616_4_.getBlockPos().relative(p_180616_4_.getDirection()), (BlockRayTraceResult) null);
            }
    ...
    {
        if (this.getClass() == BladderItem.class)
